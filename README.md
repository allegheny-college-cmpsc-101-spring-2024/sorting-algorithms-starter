...
- This project has been adapted from
  [Proactive Programmers' material](https://proactiveprogrammers.com/data-abstraction/engineering-efforts/sorting-algorithms/),
...
- For reference, check the
  [starter repo](https://github.com/allegheny-college-cmpsc-101-spring-2024/sorting-algorithms-starter)
